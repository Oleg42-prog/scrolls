...
from scrolls.geometry.boxes.to_xyxyn import xyxy_to_xyxyn, xywh_to_xyxyn, xywhn_to_xyxyn, cxywh_to_xyxyn
...
def cxywh_to_xyxyp(bounding_boxes, image_size):
    return cxywh_to_xyxyn(bounding_boxes, image_size) * 100
