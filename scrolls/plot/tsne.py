...
class TSNEVisualizer:
    ...
    def __init__(self, features, images_input) -> None:
    ...
    def plot_icons(self):
        show_tsne(self._tsne_results[:, 0], self._tsne_results[:, 1], self._images)

    def plot_icons_grid(self):
        tsne_to_grid_plotter_manual(self._tsne_results[:, 0], self._tsne_results[:, 1], self._images)
